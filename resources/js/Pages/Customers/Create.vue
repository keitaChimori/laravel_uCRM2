                ...
                <div class="container px-5 py-8 mx-auto">
                  <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <div class="flex flex-wrap">
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <input type="text" id="name" name="name" v-model="form.name"
                            ...
                            <div v-if="errors.name" class="text-red-500">顧客{{ errors.name }}</div>
                        </div>
                      </div>
                      <div class="p-2 w-full">
                        <div class="relative">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          <label for="tel" class="leading-7 text-sm text-gray-600">商品名</label>
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <input type="number" id="postcode" name="postcode" @change="searchAddress" v-model="form.postcode"
                            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <input type="radio" name="gender" id="gender0" v-model="form.gender" value="0">
                          <label for="gender0" class="ml-1 mr-4">男性</label>
                          <input type="radio" name="gender" id="gender1" v-model="form.gender" value="1">
                          <label for="gender1" class="ml-1 mr-4">女性</label>
                          <input type="radio" name="gender" id="gender2" v-model="form.gender" value="2">
                          <label for="gender2" class="ml-1 mr-4">その他</label>
                          <div v-if="gender" class="text-red-500">{{ errors.gender }}</div>
                        </div>
                      </div>
                      <div class="p-2 w-full">
                        <div class="relative">
