                    ...
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <textarea id="memo" name="memo" v-model="form.memo"
                            ...
                            <div v-if="errors.memo" class="text-red-500">商品{{ errors.memo }}</div>
                        </div>
                      </div>
                      <div class="p-2 w-full">
                        <div class="relative">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <input type="radio" id="1" name="is_selling" v-model="form.is_selling" value="1">
                          <label for="1" class="ml-2 mr-4">販売中</label>
                          <input type="radio" id="0" name="is_selling" v-model="form.is_selling" value="0">
                          <label for="0" class="ml-2 mr-4">停止中</label>
                        </div>
                      </div>
                      <div class="p-2 w-full">
                        <button
